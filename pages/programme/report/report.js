...
Page({
  data: {
    loading:true,
    srcollviewHeight:app.globalData.systemInfo.windowHeight * _ratio - 240 - 100,//滚动区高度
    startTime:'2019年1月1日',
    endTime:'2019年9月10日',
    st:'2019-01-01',
    et:'2019-09-10',
  ...
  checkDetail(e) {
    ...
    for(let i=0;i<activitiesList.length;i++) {
      if(activitiesList[i].ACTIVITY_ID === activityId) {
        ...
        dd.navigateTo({
          url: '../report_detail/report_detail'
        })
      }
    }
  },
  ...
  getActivityList() {
    ...
    dd.httpRequest({
      ...
      data: {
        ...
        state: _this.data.reportState[_this.data.arrIndex].stateId,
        menuType: '0' //方案申报
      },
      dataType: 'json',
